...
function readMultipartBody(response, nextValue) {
  return __awaiter(this, void 0, void 0, function() {
    var decoder, contentType, delimiter, boundaryVal, boundary, buffer, iterator, running, _a3, value, done, chunk, searchFrom, bi, message, i, headers, contentType_1, body, result2, next;
    var _b, _c;
    var _d;
...
var createHttpLink = function(linkOptions) {
  ...
  return new ApolloLink(function(operation) {
    ...
    if (context.clientAwareness) {
      var _a4 = context.clientAwareness, name_1 = _a4.name, version3 = _a4.version;
      if (name_1) {
...
function equalByQuery(query, _a3, _b, variables) {
...
var ApolloCache = (
  ...
  function() {
    ...
    ApolloCache2.prototype.writeQuery = function(_a3) {
      var id = _a3.id, data = _a3.data, options = __rest(_a3, ["id", "data"]);
    ...
    ApolloCache2.prototype.writeFragment = function(_a3) {
      var id = _a3.id, data = _a3.data, fragment = _a3.fragment, fragmentName = _a3.fragmentName, options = __rest(_a3, ["id", "data", "fragment", "fragmentName"]);
      return this.write(Object.assign(options, {
...
function defaultDataIdFromObject(_a3, context) {
  var __typename = _a3.__typename, id = _a3.id, _id = _a3._id;
...
var StoreReader = (
  ...
  function() {
    ...
    StoreReader2.prototype.diffQueryAgainstStore = function(_a3) {
      var store = _a3.store, query = _a3.query, _b = _a3.rootId, rootId = _b === void 0 ? "ROOT_QUERY" : _b, variables = _a3.variables, _c = _a3.returnPartialData, returnPartialData = _c === void 0 ? true : _c, _d = _a3.canonizeResults, canonizeResults = _d === void 0 ? this.config.canonizeResults : _d;
...
var StoreWriter = (
  ...
  function() {
    ...
    StoreWriter2.prototype.writeToStore = function(store, _a3) {
      var _this = this;
      var query = _a3.query, result2 = _a3.result, dataId = _a3.dataId, variables = _a3.variables, overwrite = _a3.overwrite;
    ...
    StoreWriter2.prototype.processSelectionSet = function(_a3) {
      var _this = this;
      var dataId = _a3.dataId, result2 = _a3.result, selectionSet = _a3.selectionSet, context = _a3.context, mergeTree = _a3.mergeTree;
  ...
  function(_super) {
    ...
    ObservableQuery2.prototype.updateQuery = function(mapFn) {
      ...
      var _a3 = queryManager.cache.diff({
        ...
        returnPartialData: true,
        optimistic: false
      }), result2 = _a3.result, complete = _a3.complete;
    ...
    ObservableQuery2.prototype.applyNextFetchPolicy = function(reason, options) {
      if (options.nextFetchPolicy) {
        var _a3 = options.fetchPolicy, fetchPolicy = _a3 === void 0 ? "cache-first" : _a3, _b = options.initialFetchPolicy, initialFetchPolicy = _b === void 0 ? fetchPolicy : _b;
...
var QueryManager = (
  ...
  function() {
    ...
    QueryManager2.prototype.startGraphQLSubscription = function(options) {
      ...
      var fetchPolicy = options.fetchPolicy, _a3 = options.errorPolicy, errorPolicy = _a3 === void 0 ? "none" : _a3, _b = options.context, context = _b === void 0 ? {} : _b, _c = options.extensions, extensions = _c === void 0 ? {} : _c;
    ...
    QueryManager2.prototype.broadcastQueries = function() {
      ...
      this.queries.forEach(function(info) {
        var _a3;
        return (_a3 = info.observableQuery) === null || _a3 === void 0 ? void 0 : _a3["notify"]();
      });
    };
    ...
    QueryManager2.prototype.fetchConcastWithInfo = function(queryInfo, options, networkStatus, query) {
      ...
      var _a3 = options.fetchPolicy, fetchPolicy = _a3 === void 0 ? defaults && defaults.fetchPolicy || "cache-first" : _a3, _b = options.errorPolicy, errorPolicy = _b === void 0 ? defaults && defaults.errorPolicy || "none" : _b, _c = options.returnPartialData, returnPartialData = _c === void 0 ? false : _c, _d = options.notifyOnNetworkStatusChange, notifyOnNetworkStatusChange = _d === void 0 ? false : _d, _e = options.context, context = _e === void 0 ? {} : _e;
    ...
    QueryManager2.prototype.refetchQueries = function(_a3) {
      var _this = this;
      var updateCache = _a3.updateCache, include = _a3.include, _b = _a3.optimistic, optimistic = _b === void 0 ? false : _b, _c = _a3.removeOptimistic, removeOptimistic = _c === void 0 ? optimistic ? makeUniqueId("refetchQueries") : void 0 : _c, onQueryUpdated = _a3.onQueryUpdated;
    ...
    QueryManager2.prototype.maskOperation = function(options) {
      ...
      if (globalThis.__DEV__ !== false) {
        ...
        var operationType = (_a3 = getOperationDefinition(document)) === null || _a3 === void 0 ? void 0 : _a3.operation;
...
var ApolloClient = (
  ...
  function() {
    ...
    ApolloClient2.prototype.watchFragment = function(options) {
      var _a3;
      return this.cache.watchFragment(__assign(__assign({}, options), (_a3 = {}, _a3[Symbol.for("apollo.dataMasking")] = this.queryManager.dataMasking, _a3)));
    };
...
var useSyncExternalStore = realHook || function(subscribe2, getSnapshot, getServerSnapshot) {
  ...
  if (
    ...
    globalThis.__DEV__ !== false && invariant2.error(91);
  }
  var _a3 = React5.useState({
...
function parser(document) {
  warnDeprecated("parser", function() {
    globalThis.__DEV__ !== false && invariant2.warn(93);
  });
  if (!cache) {
  ...
  invariant2(!!document && !!document.kind, 94, document);
  var fragments = [];
  var queries = [];
  var mutations = [];
  var subscriptions = [];
  for (var _i = 0, _a3 = document.definitions; _i < _a3.length; _i++) {
    var x = _a3[_i];
  ...
  invariant2(!fragments.length || queries.length || mutations.length || subscriptions.length, 95);
  invariant2(
  ...
  invariant2(definitions.length === 1, 97, document, definitions.length);
...
function useQuery_(query, options) {
  ...
  var _a3 = useQueryInternals(query, options), result2 = _a3.result, obsQueryFields = _a3.obsQueryFields;
...
function useInternalState(client, query, options, renderPromises, makeWatchQueryOptions) {
  ...
  var _a3 = React12.useState(createInternalState), internalState = _a3[0], updateInternalState = _a3[1];
...
function useQueryInternals(query, options) {
  ...
  var _a3 = useInternalState(client, query, options, renderPromises, makeWatchQueryOptions), _b = _a3[0], observable = _b.observable, resultData = _b.resultData, onQueryExecuted = _a3[1];
...
function createMakeWatchQueryOptions(client, query, _a3, isSyncSSR) {
  ...
  var skip = _a3.skip, ssr = _a3.ssr, onCompleted = _a3.onCompleted, onError = _a3.onError, defaultOptions2 = _a3.defaultOptions, otherOptions = __rest(_a3, ["skip", "ssr", "onCompleted", "onError", "defaultOptions"]);
...
function useLazyQuery(query, options) {
  ...
  var document = (_a3 = merged === null || merged === void 0 ? void 0 : merged.query) !== null && _a3 !== void 0 ? _a3 : query;
  ...
  var eagerMethods = React13.useMemo(function() {
    ...
    var _loop_1 = function(key2) {
      ...
      eagerMethods2[key2] = function() {
        if (globalThis.__DEV__ !== false) {
          if (key2 === "reobserve") {
            globalThis.__DEV__ !== false && invariant2.warn(79);
          }
        }
  ...
  var execute3 = React13.useCallback(function(executeOptions) {
    if (globalThis.__DEV__ !== false) {
      ...
      for (var _a4 = 0, DEPRECATED_EXECUTE_OPTIONS_1 = DEPRECATED_EXECUTE_OPTIONS; _a4 < DEPRECATED_EXECUTE_OPTIONS_1.length; _a4++) {
        var name_2 = DEPRECATED_EXECUTE_OPTIONS_1[_a4];
...
function useMutation(mutation, options) {
  ...
  var _a3 = React14.useState({
    called: false,
    loading: false,
    client
  }), result2 = _a3[0], setResult2 = _a3[1];
...
function useSubscription(subscription, options) {
  ...
  if (!hasIssuedDeprecationWarningRef.current) {
    ...
    if (options.onSubscriptionData) {
      globalThis.__DEV__ !== false && invariant2.warn(options.onData ? 84 : 85);
    }
    if (options.onSubscriptionComplete) {
      globalThis.__DEV__ !== false && invariant2.warn(options.onComplete ? 86 : 87);
    }
  }
  ...
  var _a3 = React15.useState(options.skip ? null : recreate), observable = _a3[0], setObservable = _a3[1];
    ...
    var subscription2 = observable.subscribe({
      next: function(fetchResult) {
        ...
        if (!ignoreResultsRef.current)
          update();
        if (result2.error) {
          (_b = (_a4 = optionsRef.current).onError) === null || _b === void 0 ? void 0 : _b.call(_a4, result2.error);
      ...
      error: function(error) {
        ...
        if (!subscriptionStopped) {
          ...
          if (!ignoreResultsRef.current)
            update();
          (_b = (_a4 = optionsRef.current).onError) === null || _b === void 0 ? void 0 : _b.call(_a4, error);
        }
      },
      complete: function() {
        if (!subscriptionStopped) {
  ...
  var restart = React15.useCallback(function() {
    invariant2(!optionsRef.current.skip, 88);
...
function useFragment_(options) {
  ...
  var diff = React17.useMemo(function() {
    var fragment = stableOptions.fragment, fragmentName = stableOptions.fragmentName, from3 = stableOptions.from, _a3 = stableOptions.optimistic, optimistic = _a3 === void 0 ? true : _a3;
    if (from3 === null) {
      return {
        result: diffToResult({
          result: {},
...
function assertWrappedQueryRef(queryRef) {
  invariant2(!queryRef || QUERY_REFERENCE_SYMBOL in queryRef, 92);
}
  ...
  function() {
    ...
    InternalQueryReference2.prototype.handleNext = function(result2) {
      ...
      switch (this.promise.status) {
        case "pending": {
          ...
          this.result = result2;
          (_a3 = this.resolve) === null || _a3 === void 0 ? void 0 : _a3.call(this, result2);
          break;
        }
        default: {
    ...
    InternalQueryReference2.prototype.initiateFetch = function(returnedPromise) {
      ...
      returnedPromise.then(function() {
        ...
        var _a3;
        return (_a3 = _this.reject) === null || _a3 === void 0 ? void 0 : _a3.call(_this, error);
      });
  ...
  function() {
    ...
    FragmentReference2.prototype.handleNext = function(result2) {
      ...
      switch (this.promise.status) {
        case "pending": {
          if (result2.complete) {
            return (_a3 = this.resolve) === null || _a3 === void 0 ? void 0 : _a3.call(this, result2.data);
          }
          this.deliver(this.promise);
          break;
        }
...
function validateFetchPolicy(fetchPolicy) {
  ...
  invariant2(supportedFetchPolicies.includes(fetchPolicy), 89, fetchPolicy);
}
function validatePartialDataReturn(fetchPolicy, returnPartialData) {
  if (fetchPolicy === "no-cache" && returnPartialData) {
    globalThis.__DEV__ !== false && invariant2.warn(90);
  }
}
...
function useSuspenseFragment_(options) {
  ...
  var _a3 = React20.useState(fragmentRef === null ? NULL_PLACEHOLDER : [fragmentRef.key, fragmentRef.promise]), current = _a3[0], setPromise = _a3[1];
...
function useLoadableQuery(query, options) {
  ...
  var loadQuery = React21.useCallback(function() {
    ...
    invariant2(!calledDuringRender(), 81);
  ...
  var subscribeToMore = React21.useCallback(function(options2) {
    invariant2(internalQueryRef, 82);
...
function useQueryRefHandlers_(queryRef) {
  assertWrappedQueryRef(queryRef);
  var _a3 = React22.useState(queryRef), previousQueryRef = _a3[0], setPreviousQueryRef = _a3[1];
  ...
  function preloadQuery(query, options) {
    ...
    var queryRef = muteDeprecations("canonizeResults", function() {
      ...
      return new InternalQueryReference(client.watchQuery(__assign(__assign({}, options), { query })), {
        autoDisposeTimeoutMs: (_b = (_a3 = client.defaultOptions.react) === null || _a3 === void 0 ? void 0 : _a3.suspense) === null || _b === void 0 ? void 0 : _b.autoDisposeTimeoutMs
      });
    });
